...
export default async function LearnPage() {
  ...
  return (
    <>
      <PageHero eyebrow="Learn" title="From first look to first light" description="Self-paced tracks written by members, plus lessons from our workshops. No prerequisites — just curiosity." />
