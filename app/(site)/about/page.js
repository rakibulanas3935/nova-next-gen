...
export default async function AboutPage() {
  ...
  return (
    <>
      <PageHero eyebrow="About us" title="Empowering the next generation of explorers" description="We believe the next generation of scientists, engineers and innovators is already here — they just need the spark.">
