    ...
    return (
        ...
        >
            <motion.div style={{ y: headerY }}>
                <Hero title="Star Gallery" description="Explore stunning photos and visuals of the night sky captured by our astronomy community." path="/deep sky_1.mp4" />
            </motion.div>
